...
<div v-if="1==0">
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Detalle del Seguimiento de Campañas</legend>
        <table>
            <tr>
                <td>DNI</td>
        ...
        <fieldset class="scheduler-border">
            <legend class="scheduler-border">Resultado Busqueda</legend>
